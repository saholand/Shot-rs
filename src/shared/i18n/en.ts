export const en: Record<string, string> = {
  ...
  'settings.clickZoomDesc': 'Enables the Zoom tool in the live toolbar — pick a level, click a point on the screen to pan-and-zoom there',
  'settings.zoomLevel': 'Default zoom level',
  'settings.zoomLevelDesc': 'Starting level when you enter zoom mode (you can change it on the fly)',
  ...
  'liveToolbar.zoom': 'Zoom (click to focus)',
  'liveToolbar.zoomLevel': 'Level',
  'liveToolbar.zoomReset': 'Reset',
